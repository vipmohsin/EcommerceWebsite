            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="view-products.php" class="nav-link  active"><i class="fa fa-laptop me-2"></i>View Products</a>
...
<div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded-top p-4">
                    <div class="row">
  <section>
 <h1 align="center" class="my-3">Products</h1>
...
<?php while($row=mysqli_fetch_array($result)){?>
  <tbody>
    <tr >
      ...
      <td class="text-dark"><?php echo $row[3]; ?></td>
      <td class="text-dark"><?php echo $row[4]; ?></td>
      <td class="text-dark" >
        
      <p><?php echo $row[5]; ?></p></td>
      <td class="text-dark"><?php echo $row[7]; ?>
      </td>
      <td>
       <a href="edit.php?pid=<?php echo $row[0];?>">Edit</a> ||
       <a href="delete.php?pid=<?php echo $row[0];?>">Delete</a>
      </td>
    </tr>
